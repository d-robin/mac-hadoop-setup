...
#   $ start-yarn.sh
# 
# -- Robin (d.robin@gmail.com) -- 2016-08 --
...
sed -i '.backup1' "s/<protobuf.version>.*/<protobuf.version>2.5.0</protobuf.version>/"
mvn clean package -DskipTests=true -Dmaven.javadoc.skip=true -f apache-tez-0.8.4-src/pom.xml

# Step 3: Setup environment
mkdir -p /opt/tez/conf /opt/tez/tez /opt/tez/tez /opt/tez/lib
cp apache-tez-0.8.4-src/tez-dist/target/tez-0.8.4-minimal.tar.gz apache-tez-0.8.4-src/tez-dist/target/tez-0.8.4.tar.gz apache-tez-0.8.4-src/tez-examples/target/tez-examples-0.8.4.jar /opt/tez
tar xzvf /opt/tez/tez-0.8.4-minimal.tar.gz -C /opt/tez/lib

echo 
'<configuration>
	<property>
		<name>tez.lib.uris</name>
		<value>hdfs://localhost:9000/tez/tez-0.8.4.tar.gz</value>
	</property>
